...
One line per memory. Every model (Codex, Gemini, Claude Code) reads this first.
Write new memories with `.ai/bin/remember.sh "title" "body" [type] [tags]`.
...
- [CRITICAL: Gemini API key is exposed in the browser](memory/2026-06-08-critical-gemini-api-key-is-exposed-in-the-browser.md) — mistake · security,saas,gemini,architecture _(claude, 2026-06-08)_
