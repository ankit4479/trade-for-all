...
async function seed() {
  ...
  await db
    ...
    .values([
      ...
      {
        name: 'WTO Timeseries API (MFN applied rates)',
        ...
        notes: 'Indicators HS_A_0010/0020/0030/0040/0050. Needs WTO_API_KEY.',
      },
      {
        name: 'WTO Timeseries API (preferential rates, p=all)',
        url: 'https://api.wto.org/timeseries/v1/data',
        jurisdictionCode: 'WORLD',
        layer: 'duty_preferential',
        accessMethod: 'api',
        reliabilityTier: 'authoritative_api',
        volatilityClass: 'annual',
        notes: 'Indicator HS_P_0070 with p=all — all partners that grant preferences to the reporter. Needs WTO_API_KEY.',
      },
      {
